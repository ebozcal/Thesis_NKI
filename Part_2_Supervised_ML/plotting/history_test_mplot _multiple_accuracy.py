...
ax1.plot(savgol_filter(historyCNN_masked_20["acc"][14:150], 37, 1))
#ax1.plot(savgol_filter(historyCNN_crp_20["loss"][14:], 17, 1))
ax1.plot(savgol_filter(historyresnet_crp_20["acc"][14:150], 17, 1))
ax1.plot(savgol_filter(historyresnetmasked20["acc"][14:], 17, 1))
ax1.plot(savgol_filter(historyresnetcrp_10_next["acc"][14:], 17, 1))
ax1.plot(savgol_filter(historyresnet_2chmasked_10_next["acc"][14:], 17, 1))
...
ax2.plot(savgol_filter(historyCNN_masked_20["val_acc"][14:150], 37, 1))
#ax2.plot(savgol_filter(historyCNN_crp_20["val_loss"][14:], 17, 1))
ax2.plot(savgol_filter(historyresnet_crp_20["val_acc"][14:150], 17, 1))
ax2.plot(savgol_filter(historyresnetmasked20["val_acc"][14:], 17, 1))
ax2.plot(savgol_filter(historyresnetcrp_10_next["val_acc"][14:], 17, 1))
ax2.plot(savgol_filter(historyresnet_2chmasked_10_next["val_acc"][14:], 17, 1))
ax2.plot(savgol_filter(historyCNN_masked_10next["val_acc"][14:], 17, 1))
...
ax2.set_ylabel("Accuarcy", fontsize = 12)
ax1.set_title("Training accuracy with different labels and data")
ax2.set_title("Validation accuracy with different labels and data")
ax1.legend(["CNNlb20&masked",  "RNetlb20&cropped",  "RNetlb20&masked", "RNetlb10next&cropped", "RNetlb10next&2chmasked", "CNNlb10next&masked"], loc=2, fontsize = 10)
ax2.legend(["CNNlb20&masked",  "RNetlb20&cropped", "RNetlb20&masked", "RNetlb10next&cropped", "RNetlb10next&2chmasked", "CNNlb10next&masked"], loc=4, fontsize = 10)
plt.tight_layout()
plt.show()
