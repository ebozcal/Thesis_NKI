...
from define_model_cropped import  cnn3d3
...
df_train = df.iloc[:471, :]
df_val =df.iloc[471:633, :]
df_test =df.iloc[633:, :]
#df = df.drop([499])
#df_train = df.iloc[:471, :]
#df_val =df.iloc[471:633, :]
...
early_stopper = EarlyStopper(patience=70, min_delta=0.01)
acc_list =[]
loss_list = []
val_acc_list = []
val_loss_list = []
for epoch in range(200):
    ...
    print("CNN_SGD76_dr04_Epoch:{},... Time:{}.....Train_loss:{}....Train_acc:{}....Val_loss:{}.....val_acc:{}".format(epoch, round(time_elapsed,2),  round(train_loss, 3), round(train_acc, 3), round(val_loss, 3),  round(val_acc, 3)))
history_dict = {"acc":acc_list, "loss":loss_list, "val_acc":val_acc_list, "val_loss":val_loss_list}
with open('CNN_SGD_762_dr04_history_cropped_10next.pkl', 'wb') as f:
...
with open('CNN_SGD_762_dr04_label__pred_cropped_10next.pkl', 'wb') as f:
