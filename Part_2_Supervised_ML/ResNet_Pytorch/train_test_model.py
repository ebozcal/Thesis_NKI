...
test_generator = DataGenerator(list(dict_test.keys()), mask_list_test, dict_test, augment = False, batch_size=2, **params)

criterion = nn.CrossEntropyLoss()
    # getting model
model = generate_ResNet(50, 8)
dev="cuda"
model.to(dev)
...
for epoch in range(200):
    ...
    print("ResNet50_masked_20_Epoch:{},... Time:{:.3f}.....Train_loss:{:.3f}....Train_acc:{:.3f}....Val_loss:{:.3f}.....val_acc:{}".format(epoch, round(time_elapsed,2),  train_loss, train_acc, val_loss,  val_acc))
history_dict = {"acc":acc_list, "loss":loss_list, "val_acc":val_acc_list, "val_loss":val_loss_list}
with open('ResNet50_history_masked_20.pkl', 'wb') as f:
...
with open('ResNet50_label__pred_masked_20.pkl', 'wb') as f:
